...
export const BLOG_POST_QUERY = groq`*[_type == "blogPost"]{_id, ueberschrift, datum, text, bild}`
export const HOME_QUERY = groq`*[_type == "home"] {_id, seite, bild, logo, text}`
export const KONTAKT_QUERY = groq`*[_type == "kontakt"] {_id, ueberschriftNavigation, text}`
...
export const SCHWERPUNKTE_POST_QUERY = groq`*[_type == "schwerpunktePost"] {_id, ueberschriftNavigation, text}`
