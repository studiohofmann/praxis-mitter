...
export const ANFAHRT_QUERY = groq`*[_type == "anfahrt"]{_id, ueberschriftNavigation, text}`
...
export const KONTAKT_QUERY = groq`*[_type == "kontakt"] {_id, ueberschriftNavigation, textFormular, textIcons, textInstagram}`
...
export const PRAXIS_QUERY = groq`*[_type == "praxis"] {_id, ueberschriftNavigation, text, galerie[]}`
